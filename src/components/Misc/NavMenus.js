...
import { Menu, Avatar, MenuHandler, MenuItem, MenuList, Typography } from '@material-tailwind/react';
...
const NavLink = ({ href, className, children }) => (
  <Link
    to={href}
    className={` font-medium transition-colors hover:text-primary ${className || ''}`}
  >
    {children}
  </Link>
);
        ...
        <NavigationMenuItem>
          <Menubar className="border-0  border-transparent">
            <MenubarMenu>
              ...
              <MenubarContent>
                <Link to="/dashboard/user/project/new" className='cursor-pointer'>
                  <MenubarItem>
                ...
                <MenubarSeparator />
                <Link>
                  <MenubarItem className="text-red-500">Deleted Boards</MenubarItem>
                </Link>
              </MenubarContent>
            </MenubarMenu>
          </Menubar>
          ...
          <Menubar className="border-0  border-transparent">
            <MenubarMenu>
              ...
              <MenubarContent>
                ...
                <MenubarSeparator />
                <Link>
                  <MenubarItem className="text-red-500">Deleted Docs</MenubarItem>
                </Link>
              </MenubarContent>
            </MenubarMenu>
          </Menubar>
...
export const BeforeLoginMenu = () => {
  return (
    <nav className='flex items-center space-x-4 lg:space-x-6 '>
      ...
      <NavLink href="/examples/dashboard" className="text-muted-foreground">Customers</NavLink>
      <NavLink href="/examples/dashboard" className="text-muted-foreground">Products</NavLink>
      <NavLink href="/examples/dashboard" className="text-muted-foreground">Settings</NavLink>
    </nav>
  )
}
...
export const UserMenu = (props) => {
  return (<Menu>
    ...
    <MenuList>
      ...
      <MenuItem className="flex items-center gap-2 " onClick={props.handleLogout}>
        <svg
          width="16"
          height="14"
          viewBox="0 0 16 14"
    ...
    <>
      <div className="bg-indigo-600 px-4 py-3 text-white">
        <p className="text-center text-sm font-medium">
          ...
          <Link to="#" className="inline-block underline ml-4">Demo API deployed on Render</Link>
        </p>
      </div>
