...
const CardHeaderContent = (props) => (
  <div>
    ...
    <CardDescription className="text-extralight text-start">
      {props.description || ""}
    </CardDescription>
  </div>
);
...
const UserAvatar = (props) => (
  <p className="hidden sm:block -mr-2 -mt-2 sm:text-xs sm:text-gray-500 lg:flex gap-1 items-center">
    <Link
      to="#"
      className="font-medium underline hover:text-gray-700 flex items-center gap-1"
    >
...
const DueDateInfo = (props) => (
  <div className="flex gap-2 items-center">
    <div className="flex items-center gap-1 text-gray-500">
      ...
      <p className="text-xs">
        {" "}
        Due {moment(props.deadline, moment.ISO_8601).fromNow()}
      </p>
    </div>
...
const CardContextMenu = (props) => (
  <ContextMenu>
    ...
    <ContextMenuContent>
      ...
      <Separator />
      <ContextMenuItem
        className="mt-2 bg-red-500 hover:bg-red-600 cursor-pointer text-white dark:text-white"
        onClick={props.HandleRemoveCard}
      >
        Delete
      </ContextMenuItem>
    </ContextMenuContent>
...
export const CardforDrag = (props) => <CardContextMenu {...props} />;
