        ...
        <div className="board__top dark:bg-[#111111] flex justify-between items-center sticky top-0  p-5 shadow-lg border-b-2 z-40 bg-white">
          <div>
            {show ? (
              ...
              >
                ...
                <span className="total__cards exo-font text-blue-gray-400 text-sm ml-2">
                  {props.card?.length} Task
                </span>
              </h1>
            )}
          </div>
          ...
          <Menu>
            <MenuHandler className="cursor-pointer ">
              <span variant="text">
                <TfiLayoutMenuSeparated className="w-6 h-6" />
              </span>
            </MenuHandler>
            <MenuList className="dark:bg-dark border-1 border-[#1c1c1c] shadow-md shadow-gray-900">
              <MenuItem
                className="text-red-500 flex gap-2 items-center hover:bg-red-700 hover:text-white"
